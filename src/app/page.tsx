...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero — converted from components/homescreen/hero.blade.php */}
      ...
      {/* Treatments — converted from components/homescreen/service.blade.php + servicecard.blade.php */}
      ...
      {/* Why choose us — converted from components/homescreen/whychooseus.blade.php */}
